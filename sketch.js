...
function setup() {
  ...
  spaceShip2= createSprite(100, height-200, 50,50);
...
function draw() {
  ...
  if(gameState===1){
    ...
    if (laserGroup.collide(spaceShip2)){
...
function drawspaceShip2(){
  spaceShip2 = createSprite(50,50,40,40);
  spaceShip2.addImage(spaceShip2Img);
  spaceShip2.x = Math.round(random(50,750));
  spaceShip2.scale = 0.2;
  spaceShip2.velocityX = 8;
